  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        ...
        child: BlocBuilder<EditCreateTeamCubit, EditCreateTeamState>(
          ...
          return editCreateTeamCubit.state.onCreate == false
              ? Scaffold(
                  appBar: AppBar(
                      ...
                      child: Column(
                          ...
                          children: [
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: PictureUploadPickerWidget(
                                          onPictureUploadChangedHandler:
                                              (image) => editCreateTeamCubit
                                                  .onPictureUploadChanged(
                                                      image),
                                          image: editCreateTeamCubit
                            ...
                            TextFieldWidget(
                              ...
                              hint: "Team Name",
                              value:
                                  editCreateTeamCubit.state.teamNameInput.value,
                            ...
                            Center(
                                child: ElevatedButton(
                                    onPressed: () {
                                      if (editCreateTeamCubit.finish()) {
                                        editCreateTeamCubit.onCreate();
                                        editCreateTeamCubit
                                            .createNewTeam(
